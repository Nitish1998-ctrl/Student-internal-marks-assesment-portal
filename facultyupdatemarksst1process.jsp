...
st.executeUpdate("update marksst1 set name='"+name+"',email='"+email+"',admissionnumber='"+admissionno+"',mobilenumber='"+mobilenumber+"',dateofbirth='"+dob+"',branch='"+branch+"',year='"+year+"',section='"+section+"',semester='"+semester+"',subject1='"+subject1+"',subject2='"+subject2+"',subject3='"+subject3+"',subject4='"+subject4+"',subject5='"+subject5+"',subject6='"+subject6+"',maxmarks='"+maxmarks+"',marks='"+marks+"',remarks='"+remarks+"' where rollno='"+rollno+"'");
