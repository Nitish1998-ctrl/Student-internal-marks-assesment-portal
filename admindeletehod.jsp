...
<body>
<form action="admindeletehod.jsp">
<table>
<tr>
...
String sql = "DELETE FROM adminaddhod WHERE id="+id;
ps = con.prepareStatement(sql);
int i = ps.executeUpdate();
if(i > 0)
{%>
<%
out.println("Record Deleted Successfully ! Please <a href='Admin.jsp'> Go Back</a> to Home.");
%>
<% 
}
else
