...
ResultSet rs=st.executeQuery("select * from facultyregistrationform where password='"+oldpass+"'");
while(rs.next()){
id=rs.getString(1);
pass=rs.getString(3);
}
...
out.println("Password changed successfully <a href='facultydashboard.jsp'> Back to Home Page</a>.");
st1.close();
con.close();
}
else{
